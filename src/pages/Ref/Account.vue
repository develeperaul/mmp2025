<template>
  <q-page class="tw-container tw-grid env-t env-b page-a" v-if="user">
    <div class="tw-grid tw-grid-rows-[auto_1fr] tw-content-start tw-h-full">
      ...
      <div>
        <div
          class="tw-bg-black tw-px-5 tw-py-[18px] tw-rounded-xl tw-content-start tw-text-white tw-grid tw-gap-2.5 tw-mb-[30px] tw-h-fit"
        >
        ...
        <Form @submit="send" class="tw-grid tw-gap-[60px]">
          <div class="tw-grid tw-gap-5">
            ...
            <div>
              ...
              />
              <div
                class="tw-text-secondary tw-text-xs tw-mt-2.5"
                v-if="amountError"
              >
                {{ amountError }}
              </div>
              <div class="tw-text-[13px] tw-text-secondary tw-mt-2.5">
          ...
          <base-button
            type="submit"
            :load="loading"
            :disabled="loading || amountError !== false"
            class="!tw-w-[200px] tw-justify-self-center"
          >
            Вывести
          </base-button>
        </Form>
