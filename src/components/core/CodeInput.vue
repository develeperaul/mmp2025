...
.input-code {
  ...
  @apply tw-bg-transparent tw-border tw-rounded-xl tw-bg-white tw-border-stroke  tw-font-medium tw-text-center tw-w-[60px] tw-h-[60px] focus:tw-border-error;
  @apply focus:tw-outline-none focus:tw-border-error valid:tw-border-error;
}
